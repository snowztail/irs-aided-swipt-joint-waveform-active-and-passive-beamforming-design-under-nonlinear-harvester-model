...
\begin{document}
	...
	\begin{reviewersection}
		...
		\begin{response}
			...
			the reflection coefficient not only has a magnitude smaller than 1 but also depends on the phase shift. \cite{Abeywickrama2019} found that $\lvert{\phi}_l\rvert$ experiences a trough as low as \num{0.2} for $R_l = 2.5\,\si{\ohm}$ at zero phase shift, which suggests that the position and direction of the IRS should be carefully designed.
		\end{response}
