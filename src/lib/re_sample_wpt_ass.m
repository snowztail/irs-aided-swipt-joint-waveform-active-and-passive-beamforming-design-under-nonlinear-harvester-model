function [sample, solution] = re_sample_wpt_ass(beta2, beta4, directChannel, incidentChannel, reflectiveChannel, txPower, noisePower, nCandidates, tolerance)
    % Function:
	...
	[~, infoAmplitude, powerAmplitude, infoRatio, powerRatio] = waveform_ass(beta2, beta4, channel, txPower);
