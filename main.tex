...
\begin{section}{Single-User Optimization}
	...
	\begin{maxi!}
		...
		\addConstraint{\lvert{\phi}\rvert=1, \quad l=1,\dots,L}
			...
			\begin{figure*}[b]
				...
				\begin{equation}\label{eq:z_gp}
					\begin{split}
						...
						& \quad + \frac{3}{2}{\beta_4}{\rho^2} \left( \sum_{n_1,n_2} \sum_{m_1,m_2,m_3,m_4} \prod_{j=1,3} a_{n,m_j}s_{I,n,m_j} \prod_{j=2,4} a_{n,m_j}s_{P,n,m_j} \right)
					\end{split}
				\end{equation}
			\end{figure*}
