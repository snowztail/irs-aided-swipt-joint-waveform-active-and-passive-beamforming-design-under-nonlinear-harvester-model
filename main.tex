...
\begin{document}
	...
	\begin{section}{System Model}\label{se:system_model}
		...
		\begin{subsection}{Received Signal}
			...
			\begin{equation}
				y(t) = \Re\left\{\sum_{n=1}^N{\boldsymbol{h}_{n}^H}{(\boldsymbol{w}_{\mathrm{I},n}\tilde{x}_{\mathrm{I},n}(t)+\boldsymbol{w}_{\mathrm{P},n})}{e^{j2{\pi}{f_n}{t}}}+y_n(t)\right\},
			\end{equation}
			where $y_n(t)$ is the noise at RF band $n$. Note that the modulated component can be used for energy harvesting if necessary, but the multisine component carries no information and cannot be used for decoding.
		\end{subsection}
		...
		\begin{subsection}{Information Decoder}
			A major benefit of the superposed waveform is that the multisine is deterministic and creates no interference to the modulated waveform \cite{Clerckx2018b}. Therefore, the achievable rate is\footnote{It is achievable with waveform cancellation or translated demodulation \cite{Clerckx2018b}.}
