...
\begin{document}
	...
	\begin{section}{Performance Evaluations}\label{se:performance_evaluation}
		...
		\begin{figure}[!t]
			\centering
			\begin{adjustbox}{width=0.25\columnwidth}
