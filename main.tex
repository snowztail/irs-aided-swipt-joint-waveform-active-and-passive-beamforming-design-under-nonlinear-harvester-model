...
\begin{section}{Performance Evaluations}
	...
	The influence of the average noise power on the average R-E region is investigated in Fig. \ref{fi:re_noise}. For a sufficiently large $N$, the R-E region is approximately concave for a high noise level and approximately convex for a low noise level. As a result, TS is preferred at low SNR while PS is preferred at high SNR.
