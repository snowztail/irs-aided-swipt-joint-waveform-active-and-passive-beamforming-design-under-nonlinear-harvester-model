	...
	\begin{appendix}
		\begin{subsection}{Proof of Proposition~\ref{pr:relaxation}}\label{ap:relaxation}
			...
			\begin{subequations}
				...
				\end{equation}
			\end{subequations}
			and we derive the gradient explicitly and rewrite \eqref{eq:gradient} as
			\begin{equation}
