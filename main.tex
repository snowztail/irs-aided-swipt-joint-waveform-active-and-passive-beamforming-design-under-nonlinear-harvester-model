...
\begin{document}
	...
	\begin{section}{Performance Evaluations}\label{se:performance_evaluation}
		...
		\begin{figure}[!t]
			...
			\end{adjustbox}
			\caption{Average WIT SNR and WPT DC current versus $M$ for $N=16$, $L=20$, $\sigma_n=-40\,\si{\dBm}$, $B=1\,\si{\MHz}$ and $d_H=\text{[TODO]}\,\si{\meter}$.}
			\label{fi:scaling_tx}
		\end{figure}
