	...
	\begin{subsection}{Single-User Optimization}
		...
		\begin{subsubsection}{Frequency-Flat IRS}
			...
			\begin{figure*}[b]
				...
				\end{equation}
			\end{figure*}
			Introduce auxiliary variables $t_{I/P,n}=\boldsymbol{h}^H\boldsymbol{M}_{I/P,n}\boldsymbol{h}=\mathrm{Tr}(\boldsymbol{h}\boldsymbol{h}^H\boldsymbol{M}_{I/P,n})=\mathrm{Tr}(\boldsymbol{H}\boldsymbol{M}_{I/P,n})$


			and we have $t_{I/P,n}t_{I/P,n}^*=t_{I/P,-n}t_{I/P,-n}^*$ by noticing $\boldsymbol{M}_{I/P,-n}=\boldsymbol{M}_{I/P,n}^H$. Further define $\boldsymbol{t}_{I/P}=[t_{I/P,1},\dots,t_{I/P,N-1}]^T \in \mathbb{C}^{N-1}$.
