...
\begin{section}{Problem Formulation}
	...
	\begin{subsection}{Single-User Optimization}
		...
		\end{maxi}
		Since the objective function is non-convex with $\Theta_0$ and $\boldsymbol{w}_I$ coupled, \ref{op:1} is a non-convex problem. To reduce the design complexity, we propose an suboptimal alternating optimization algorithm that updates the information weight at the transmitter and the phase shifts at the IRS iteratively until convergence. It leads to a local optimum and is sensitive to the initialization of $\Theta_0$, $\boldsymbol{w}_I$ and $\boldsymbol{w}_P$.
