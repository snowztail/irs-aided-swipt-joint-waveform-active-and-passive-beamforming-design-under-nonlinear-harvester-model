		...
		\begin{subsubsection}{Waveform optimization}
			...
			\begin{figure*}[b]
				...
				\begin{align}
					...
					& \quad + \frac{1}{2}(a^{(i-1)} + b^{(i-1)})(a^{(i)} + b^{(i)}) - \frac{1}{4}(a^{(i-1)} + b^{(i-1)})^2 - \frac{1}{4}(a^{(i)} - b^{(i)})^2\label{eq:z_waveform_lb}\\
					g^{(i)}
