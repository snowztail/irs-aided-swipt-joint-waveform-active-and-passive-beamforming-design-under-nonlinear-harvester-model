		...
		\begin{figure*}[b]
			...
			\begin{equation}\label{eq:z_k_su}
				\begin{split}
					...
					&\quad+\frac{3}{8}{k_4}{\rho^2}{R_{\text{ant}}^2}\sum_{n=-N+1}^{N-1}\left(2\boldsymbol{w}_I^H\boldsymbol{M}_n\boldsymbol{w}_I(\boldsymbol{w}_I^H\boldsymbol{M}_n\boldsymbol{w}_I)^H+\boldsymbol{w}_P^H\boldsymbol{M}_n\boldsymbol{w}_P(\boldsymbol{w}_P^H\boldsymbol{M}_n\boldsymbol{w}_P)^H\right)\\
