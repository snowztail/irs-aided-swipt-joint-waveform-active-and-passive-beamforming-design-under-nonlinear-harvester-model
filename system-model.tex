...
\begin{section}{Problem Formulation}
	...
	\begin{subsection}{Single-User Optimization}
		...
		\begin{subsubsection}{Frequency-Flat IRS}
			...
			\begin{equation}
				\begin{split}
					...
					&=\bar{\boldsymbol{v}}^H\boldsymbol{R}\bar{\boldsymbol{v}}=\mathrm{Tr}(\boldsymbol{R}\bar{\boldsymbol{v}}\bar{\boldsymbol{v}}^H)=\mathrm{Tr}(\boldsymbol{R}\boldsymbol{V})
				\end{split}
			\end{equation}
		...
		% ? AO: optimize phase shifts with given weights
