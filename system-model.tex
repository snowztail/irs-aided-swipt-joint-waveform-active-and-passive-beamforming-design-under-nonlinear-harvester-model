...
\begin{section}{Problem Formulation}
	...
	\begin{subsection}{Single-User Optimization}
		...
		\begin{maxi}
			...
			\addConstraint{\lvert{v_l}\rvert=1,\quad l=1,\dots,L}
		\end{maxi}
		Since $\lvert{h_{D,n}+\boldsymbol{\Phi}_n^H\boldsymbol{v}}\rvert^2=\lvert{h_{D,n}}\rvert^2+h_{D,n}^*\boldsymbol{\Phi}_n^H\boldsymbol{v}+\boldsymbol{v}^H\boldsymbol{\Phi}_n{h_{D,n}}+\boldsymbol{v}^H\boldsymbol{\Phi}\boldsymbol{\Phi}^H\boldsymbol{v}$, we introduce an auxiliary variable $t$ with unit modulus and transform \ref{op:temp} to
		\begin{maxi}
			{\bar{\boldsymbol{v}}}{\sum_{n}{\log_2\left(1+\frac{(1-\rho)\lvert{w}_{I,n}\rvert^2(\bar{\boldsymbol{v}}^H\boldsymbol{R}\bar{\boldsymbol{v}})}{\sigma_n^2}\right)}}{\label{op:temp1}}{}
		...
		\begin{equation}
			\boldsymbol{R}=
			\begin{bmatrix}
				\boldsymbol{\Phi}_n\boldsymbol{\Phi}_n^H & h_{D,n}^*{\boldsymbol{\Phi}_n^H} \\
				\boldsymbol{\Phi}_n{h_{D,n}}             & h_{D,n}^*{h_{D,n}}
			\end{bmatrix},
		...
		\begin{maxi}
			{\boldsymbol{V}}{\sum_{n}{\log_2\left(1+\frac{(1-\rho)\lvert{w}_{I,n}\rvert^2\mathrm{Tr}(\boldsymbol{R}\boldsymbol{V})}{\sigma_n^2}\right)}}{\label{op:temp3}}{}
